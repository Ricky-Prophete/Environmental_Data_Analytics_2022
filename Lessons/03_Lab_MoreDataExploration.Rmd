...
vector1[3] #Return 3rd component of given vector
...
```{r}
high_temps <- c(45, 50, 34, 43, 51, 54, 59, 66, 57, 42)
low_temps <- c(27, 27, 15, 25, 27, 35, 47, 53, 30, 22)
```
...
celsius_converter <- function(temp_f){
  temp_c <- (temp_f-32)*5/9
  return (temp_c)
}
high_temps_c <- celsius_converter(high_temps)
low_temps_c <- celsius_converter(low_temps)
```
